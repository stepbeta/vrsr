## vrsr hubble list-remote

List all remote hubble versions from GitHub (sorted by semver)

### Synopsis

Lists all the remote hubble versions available as GitHub releases (sorted by semver).
